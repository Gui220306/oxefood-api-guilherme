...
import br.com.ifpe.oxefood.modelo.segurança.JwtService;
...
public class AuthenticationController {
    ...
    @PostMapping
    // Método para autenticar o usuário e gerar o token JWT (caso exista usuário com o nome e senha informados)
